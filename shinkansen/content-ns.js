...
if (window.__shinkansen_loaded) {
  ...
  SK._strings = {
    'zh-TW': {
      ...
      cs_complete_partial: '已翻譯前 {0} 段（共 {1} 段）',
      cs_translate_remaining: '翻譯剩餘段落',
      ...
      cs_google_chars: '{0} 字元 · 免費', cs_bing_progress: '{0}Bing 翻譯中… {1} / {2}', cs_bing_complete_truncated: 'Bing 翻譯完成（{0} 段，另有 {1} 段因頁面過長被略過）', cs_bing_complete: 'Bing 翻譯完成（{0} 段）', cs_bing_chars: '{0} 字元 · 免費', cs_auto_translate: '自動翻譯',
      cs_selection: '選取翻譯', cs_target_lang_name: '繁體中文',
    ...
    'zh-CN': {
      ...
      cs_complete_partial: '已翻译前 {0} 段（共 {1} 段）',
      cs_translate_remaining: '翻译剩余段落',
      ...
      cs_google_chars: '{0} 字符 · 免费', cs_bing_progress: '{0}Bing 翻译中… {1} / {2}', cs_bing_complete_truncated: 'Bing 翻译完成（{0} 段，另有 {1} 段因页面过长被略过）', cs_bing_complete: 'Bing 翻译完成（{0} 段）', cs_bing_chars: '{0} 字符 · 免费', cs_auto_translate: '自动翻译',
      cs_selection: '选区翻译', cs_target_lang_name: '简体中文',
    ...
    'ja': {
      ...
      cs_complete_partial: '先頭 {0} 段を翻訳済み（全 {1} 段）',
      cs_translate_remaining: '残りの段落を翻訳',
      ...
      cs_google_chars: '{0} 文字・無料', cs_bing_progress: '{0}Bing 翻訳中… {1} / {2}', cs_bing_complete_truncated: 'Bing 翻訳完了（{0} 段、他に {1} 段がページ長超過により省略）', cs_bing_complete: 'Bing 翻訳完了（{0} 段）', cs_bing_chars: '{0} 文字・無料', cs_auto_translate: '自動翻訳',
      cs_selection: '選択範囲を翻訳', cs_target_lang_name: '日本語',
  ...
  SK.STATE = {
    ...
    originalHTML: new Map(), // el → Node[]（cloneChildSnapshot）
    // v1.0.14: 儲存翻譯後的子節點快照，用於偵測框架覆寫並重新套用。
    translatedHTML: new Map(), // el → Node[]（cloneChildSnapshot）
    // v1.0.23: 續翻模式
