...
(function (SK) {
  ...
  function _ensureOverlay() {
    ...
    // AMO 合規：用 DOM API 建構 Shadow DOM（不用 innerHTML）
    ...
    style.textContent = [
      ...
      '  padding: 0.15em 0.5em; background: rgba(0,0,0,0.78);',
      '  color: #fff; font-size: 22px; line-height: 1.5;',
      '  border-radius: 4px; white-space: pre-wrap;',
      '  text-align: center; box-sizing: border-box; letter-spacing: 0.02em;',
      '}',
