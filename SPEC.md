...
**v1.0.x 系列**：每批段數/字元預算改為設定頁選項（v1.0.2）、編輯譯文模式（v1.0.3）、程式碼重構與效能最佳化（v1.0.4，ES module 化、handler map、debounce storage 寫入）、修正用量頁面無資料（v1.0.5）、修正 manifest description 與文件重構（v1.0.6，SPEC.md v1.0 重寫、README.md 重寫、測試流程說明更新）。
